$(document).ready(function () {
  ...
  $("#add_choice").click(function(e) {
	  e.preventDefault()	  
	  $('#choices').append('<div class="control-group"><label class="control-label required">'+(i+1)+'</label><div class="controls"><input type="text" value="" name="survey[choices]['+i+'][_id]" tabindex="1"> <a class="btn remove_choice" href="#"> x </a> </div></div> ');
	  i++
	});    
